...
void MRC::printInfo() {
    ...
    //printf("\tExtra:                             %s\n",m_header.extra);
    printf("\tOrigin in X,Y,Z:                   %12.3f %12.3f %12.3f\n", m_header.origin[0], m_header.origin[1],
           m_header.origin[2]);
    printf("\tFile type:                         %c%c%c%c\n", m_header.map[0], m_header.map[1], m_header.map[2],
           m_header.map[3]);
